...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pumpkin_server', (
            ...
            ('ssh_key_pub', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'pumpkin', ['Server'])

        # Adding field 'Project.server'
        db.add_column(u'pumpkin_project', 'server',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['pumpkin.Server']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Project.server'
        db.delete_column(u'pumpkin_project', 'server_id')
    ...
    models = {
        ...
        u'pumpkin.job': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'post_job': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['pumpkin.Job']"}),
            'pre_job': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['pumpkin.Job']"}),
        ...
        u'pumpkin.project': {
            ...
            'git_remote_address': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'setup_command': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'setup_log': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        u'pumpkin.server': {
            ...
            'ssh_key_pub': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        u'pumpkin.testserver': {
            ...
            'port': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'root_password': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'ssh_key_pub': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
