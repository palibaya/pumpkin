...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Build.name'
        db.delete_column(u'pumpkin_build', 'name')
        ...
        db.add_column(u'pumpkin_job', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pumpkin.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Build.name'
        db.add_column(u'pumpkin_build', 'name',
        ...
        db.delete_column(u'pumpkin_job', 'project_id')
