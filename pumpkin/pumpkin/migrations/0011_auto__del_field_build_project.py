...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'pumpkin_build', 'project_id')


    def backwards(self, orm):
        # Adding field 'Build.project'
        db.add_column(u'pumpkin_build', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['pumpkin.Project']),
                      keep_default=False)
