...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Build.command_type'
        db.delete_column(u'pumpkin_build', 'command_type')


    def backwards(self, orm):
        # Adding field 'Build.command_type'
        db.add_column(u'pumpkin_build', 'command_type',
                      self.gf('django.db.models.fields.CharField')(default='bash', max_length=16),
                      keep_default=False)
