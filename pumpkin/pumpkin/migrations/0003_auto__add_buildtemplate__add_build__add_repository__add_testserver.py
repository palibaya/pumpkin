...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TestServer'
        db.create_table(u'pumpkin_testserver', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal(u'pumpkin', ['TestServer'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'TestServer'
        db.delete_table(u'pumpkin_testserver')
    ...
    models = {
        ...
        u'pumpkin.project': {
            ...
            'managers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'+'", 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
