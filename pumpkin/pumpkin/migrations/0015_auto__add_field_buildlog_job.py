...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BuildLog.job'
        db.add_column(u'pumpkin_buildlog', 'job',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=10, related_name='build_logs', to=orm['pumpkin.Job']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BuildLog.job'
        db.delete_column(u'pumpkin_buildlog', 'job_id')
