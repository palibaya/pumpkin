...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.remote_git_address'
        db.delete_column(u'pumpkin_project', 'remote_git_address')

        # Adding field 'Project.git_remote_address'
        db.add_column(u'pumpkin_project', 'git_remote_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Project.remote_git_address'
        db.add_column(u'pumpkin_project', 'remote_git_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'Project.git_remote_address'
        db.delete_column(u'pumpkin_project', 'git_remote_address')
