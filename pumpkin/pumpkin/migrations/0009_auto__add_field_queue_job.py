...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Queue.job'
        db.add_column(u'pumpkin_queue', 'job',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', to=orm['pumpkin.Job']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Queue.job'
        db.delete_column(u'pumpkin_queue', 'job_id')
