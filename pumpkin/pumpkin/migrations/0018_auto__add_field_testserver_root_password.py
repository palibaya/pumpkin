...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestServer.root_password'
        db.add_column(u'pumpkin_testserver', 'root_password',
                      self.gf('django.db.models.fields.CharField')(default='root', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestServer.root_password'
        db.delete_column(u'pumpkin_testserver', 'root_password')
