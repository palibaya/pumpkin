...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestServer.ssh_key_pub'
        db.add_column(u'pumpkin_testserver', 'ssh_key_pub',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestServer.ssh_key_pub'
        db.delete_column(u'pumpkin_testserver', 'ssh_key_pub')
    ...
    models = {
        ...
        u'pumpkin.project': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'remote_git_address': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
