...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Build.builder'
        db.add_column(u'pumpkin_build', 'builder',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='+', to=orm['pumpkin.Builder']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Build.builder'
        db.delete_column(u'pumpkin_build', 'builder_id')
