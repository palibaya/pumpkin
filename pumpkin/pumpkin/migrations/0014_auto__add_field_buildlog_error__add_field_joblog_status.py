...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BuildLog.error'
        db.add_column(u'pumpkin_buildlog', 'error',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'JobLog.status'
        db.add_column(u'pumpkin_joblog', 'status',
                      self.gf('django.db.models.fields.CharField')(default='success', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BuildLog.error'
        db.delete_column(u'pumpkin_buildlog', 'error')

        # Deleting field 'JobLog.status'
        db.delete_column(u'pumpkin_joblog', 'status')
