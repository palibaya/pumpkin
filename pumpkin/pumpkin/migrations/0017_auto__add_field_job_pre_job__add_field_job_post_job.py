...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.pre_job'
        db.add_column(u'pumpkin_job', 'pre_job',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['pumpkin.Job']),
                      keep_default=False)

        # Adding field 'Job.post_job'
        db.add_column(u'pumpkin_job', 'post_job',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['pumpkin.Job']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.pre_job'
        db.delete_column(u'pumpkin_job', 'pre_job_id')

        # Deleting field 'Job.post_job'
        db.delete_column(u'pumpkin_job', 'post_job_id')
