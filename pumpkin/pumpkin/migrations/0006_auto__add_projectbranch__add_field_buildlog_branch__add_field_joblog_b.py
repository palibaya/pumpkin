...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BuildLog.branch'
        db.add_column(u'pumpkin_buildlog', 'branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pumpkin.ProjectBranch'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'JobLog.branch'
        db.add_column(u'pumpkin_joblog', 'branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pumpkin.ProjectBranch'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BuildLog.branch'
        db.delete_column(u'pumpkin_buildlog', 'branch_id')

        # Deleting field 'JobLog.branch'
        db.delete_column(u'pumpkin_joblog', 'branch_id')
