...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.setup_command'
        db.add_column(u'pumpkin_project', 'setup_command',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.setup_command'
        db.delete_column(u'pumpkin_project', 'setup_command')
