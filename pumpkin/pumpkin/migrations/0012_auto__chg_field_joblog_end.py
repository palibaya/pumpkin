...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JobLog.end'
        db.alter_column(u'pumpkin_joblog', 'end', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'JobLog.end'
        db.alter_column(u'pumpkin_joblog', 'end', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 19, 0, 0)))
